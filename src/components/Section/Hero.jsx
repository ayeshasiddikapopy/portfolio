    ...
    <div className="bg-[url('src/assets/hero2.jpg')] w-full h-full py-7 bg-center bg-no-repeat bg-cover hero__bg relative z-0" >
      ...
      <Container>
          <div className="hero md:py-[120px] text-center px-2.5">
              ...
              <div className="hero__button grid md:grid-cols-6 grid-cols-2 gap-4 py-5">
                <div></div>
                <div></div>
                <div className='border border-white border-r-4 rounded-md text-white text-base font-semibold font-sans hero_btn flex items-center justify-center'>
